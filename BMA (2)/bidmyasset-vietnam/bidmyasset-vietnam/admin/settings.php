...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="section-block">
    ...
    <div class="field"><label>Page Description</label><textarea name="discover_description" rows="6" placeholder="Describe your process, ESG commitments, or anything else you'd like visitors to see on this page."><?= htmlspecialchars($settings['discover_description'] ?? '') ?></textarea></div>
  </div>

  <!-- AUCTION -->
  <div class="section-block">
    <h3>Auction Section</h3>
    <div class="section-desc">The "Leading Machinery Auction Platform" block.</div>
    <div class="section-layout">
      <div>
      ...
      <?php render_image_slot('auction_image', 'Auction Image', 'The photo shown beside the auction text.', $settings); ?>
    </div>
  </div>
